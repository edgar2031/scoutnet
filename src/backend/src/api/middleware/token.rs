...
const ISSUER: &str = "scoutnet";
const AUDIENCE: &str = "scoutnet-api";
...
pub struct Claims {
    ...
    pub exp: u64,
    /// Issuer — always `"scoutnet"`.
    pub iss: String,
    /// Audience — always `"scoutnet-api"`.
    pub aud: String,
}
...
mod tests {
    ...
    fn access_token_claims_are_correct() {
        ...
        assert_eq!(claims.iss, "scoutnet");
        assert_eq!(claims.aud, "scoutnet-api");
