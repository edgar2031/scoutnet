...
pub trait AiProvider: Send + Sync {
    ...
    async fn chat(&self, api_key: &str, req: ChatRequest) -> Result<ChatResponse, super::AiRouterError>;
    ...
    async fn validate_key(&self, api_key: &str) -> Result<(), super::AiRouterError>;
}
